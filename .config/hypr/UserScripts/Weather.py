...
latitude = "-23.55910873413086"
longitude = "-46.64729690551758"
...
# wind speed
wind_element = html_data("span[data-testid='Wind']")
span_children = wind_element.children("span")
wind = span_children.eq(1).text()
